...
public class ShurikenMain {
	...
	int shurikenCounter, timerSpeed, cursorNumber, cursorPrice, blacksmithPrice, blacksmithNumber, smithyPrice, smithyNumber, sakePrice, sakeNumber;
	double perSecond;
	...
	public void createUI() {
		...
		try {
        BufferedImage img = ImageIO.read(new File("/Users/oskarivilen/eclipse-workspace/cookieClicker/res/house.jpg"));
